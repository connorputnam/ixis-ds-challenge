---
title: "01_online_retailer_performance"
...
first_sheet <- counts_dta %>%
  ...
  group_by(dim_deviceCategory, month) %>% ### assignment asks to create a Month 8 Device aggregation
...
saveWorkbook(wb, file = here("Data", "reference_tables.xlsx"), overwrite = TRUE)
```

```{r}
### This is how I personally like to do this task.
### Find it more straight forward than the openxlsx package
write_xlsx(list(month_device = first_sheet, 
...
```{r}
purl("01_online_retailer_performance.RMD") ### creates an R script
```
